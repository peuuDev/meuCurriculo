...
public class mercado {
    ...
    static double[] total = new double [1];

    static double[] valorDesconto = new double[1];
    ...
    public static void exibirCarrinho() {
        ...
        for(int i = 0; i < valorTotal.length; i++){
            total[0] = total[0] + valorTotal[i];
        }
        System.out.println("\nVALOR TOTAL: R$: " + df.format(total[0]));
    }
    ...
    public static void finalizarCompra() {
        ...
        System.out.println("\nVALOR TOTAL: R$: " + df.format(total[0]));
        System.out.println("\nVALOR TOTAL COM DESCONTO: R$: " + df.format(total[0] * valorDesconto[0]));
        ...
        //     }
        // System.out.println("----------------------------------------");
        // System.out.println("Total sem desconto: " +df.format(total[0]));
        // System.out.println("Valor final com desconto: " +df.format(valorDesconto[0]));
        // System.out.println("-------------------------------");
